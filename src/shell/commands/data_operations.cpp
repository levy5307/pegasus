...
bool multi_get_range(command_executor *e, shell_context *sc, arguments args)
{
    ...
    while (true) {
        ...
        case 's':
            ...
            break;
        case 'y':
            options.sort_key_filter_pattern = pegasus::utils::unescape_str(optarg);
            break;
        case 'n':
...
bool check_and_set(command_executor *e, shell_context *sc, arguments args)
{
    ...
    while (true) {
        ...
        case 'c':
            ...
            check_sort_key = pegasus::utils::unescape_str(optarg);
            break;
        case 't':
        ...
        case 'o':
            ...
            check_operand = pegasus::utils::unescape_str(optarg);
            break;
        case 's':
            set_sort_key_provided = true;
            set_sort_key = pegasus::utils::unescape_str(optarg);
            break;
        case 'v':
            set_value_provided = true;
            set_value = pegasus::utils::unescape_str(optarg);
            break;
        case 'l':
...
bool hash_scan(command_executor *e, shell_context *sc, arguments args)
{
    ...
    while (true) {
        ...
        case 'v':
            ...
            break;
        case 'z':
            value_filter_pattern = pegasus::utils::unescape_str(optarg);
            break;
        case 'i':
            options.no_value = true;
            break;
...
bool full_scan(command_executor *e, shell_context *sc, arguments args)
{
    ...
    while (true) {
        ...
        case 'h':
            ...
            break;
        case 'x':
            options.hash_key_filter_pattern = pegasus::utils::unescape_str(optarg);
            break;
        case 's':
            ...
            break;
        case 'y':
            sort_key_filter_pattern = pegasus::utils::unescape_str(optarg);
            break;
        case 'v':
            value_filter_type = parse_filter_type(optarg, true);
            if (value_filter_type == pegasus::pegasus_client::FT_NO_FILTER) {
...
int load_mutations(shell_context *sc, pegasus::pegasus_client::mutations &mutations)
{
    while (true) {
        ...
        case 1: // SET
            ...
            sort_key = pegasus::utils::unescape_str(args[1]);
            value = pegasus::utils::unescape_str(args[2]);
            fprintf(stderr,
...
int mutation_check(int args_count, sds *args)
{
    int ret = -2;
    if (args_count > 0) {
        std::string op = pegasus::utils::unescape_str(args[0]);
        if (op == "abort")
            ret = -1;
        else if (op == "ok")
            ret = 0;
