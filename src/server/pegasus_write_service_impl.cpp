...
pegasus_write_service::impl::impl(pegasus_server_impl *server)
    : replica_base(server),
...
int pegasus_write_service::impl::multi_put(const db_write_context &ctx,
...
int pegasus_write_service::impl::multi_remove(int64_t decree,
...
int pegasus_write_service::impl::incr(int64_t decree,
...
int pegasus_write_service::impl::check_and_set(int64_t decree,
                                               ...
                                               dsn::apps::check_and_set_response &resp)
{
    ...
    if (passed) {
        ...
        resp.error = _rocksdb_wrapper->write_batch_put(
            decree, set_key, update.set_value, static_cast<uint32_t>(update.set_expire_ts_seconds));
    } else {
...
int pegasus_write_service::impl::check_and_mutate(int64_t decree,
...
dsn::error_code
pegasus_write_service::impl::ingestion_files(const int64_t decree,
                                             ...
                                             const dsn::replication::bulk_load_metadata &metadata)
{
    ...
    return _rocksdb_wrapper->ingest_external_file(sst_file_list, decree);
}

int pegasus_write_service::impl::batch_put(const db_write_context &ctx,
...
int pegasus_write_service::impl::batch_remove(int64_t decree,
                                              const dsn::blob &key,
                                              dsn::apps::update_response &resp)
{
    resp.error = _rocksdb_wrapper->write_batch_delete(decree, key);
...
int pegasus_write_service::impl::batch_commit(int64_t decree)
{
...
void pegasus_write_service::impl::batch_abort(int64_t decree, int err)
{
    clear_up_batch_states(decree, err);
}

void pegasus_write_service::impl::set_default_ttl(uint32_t ttl)
{
    _rocksdb_wrapper->set_default_ttl(ttl);
}

void pegasus_write_service::impl::clear_up_batch_states(int64_t decree, int err)
{
...
dsn::blob pegasus_write_service::impl::composite_raw_key(dsn::string_view hash_key,
...
bool pegasus_write_service::impl::is_check_type_supported(
...
bool pegasus_write_service::impl::validate_check(int64_t decree,
                                                 ::dsn::apps::cas_check_type::type check_type,
